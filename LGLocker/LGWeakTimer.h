...
/**
 * Creates an `LGWeakTimer` object and schedules it to start ticking inmediately.
 */
 ...
 * @note `LGWeakTimer` won't invoke the `selector` on `target` again after calling this method.
